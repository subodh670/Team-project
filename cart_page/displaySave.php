...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(isset($_SESSION['username'])){
        ...
        // $query = 
        // echo $c_id;
        $query = "SELECT PRODUCT.NAME, PRODUCT.PRICE, PRODUCT.FK_SHOP_ID, SHOP.NAME,PRODUCT.STOCK_AVAILABLE, CATEGORY.CATEGORY_NAME, PRODUCT.IMAGE2, PRODUCT.PRODUCT_ID ,SUM(CART.TOTAL_ITEMS) FROM PRODUCT, CART, SHOP, CATEGORY WHERE CART.ITEMS = PRODUCT.NAME AND PRODUCT.FK_SHOP_ID = SHOP.SHOP_ID AND CATEGORY.CATEGORY_ID = PRODUCT.FK_CATEGORY_ID AND CART.FK_USER_ID = '$c_id' GROUP BY PRODUCT.PRODUCT_ID, PRODUCT.NAME, PRODUCT.PRICE, PRODUCT.FK_SHOP_ID,PRODUCT.STOCK_AVAILABLE,PRODUCT.IMAGE2,SHOP.NAME, CATEGORY.CATEGORY_NAME";
